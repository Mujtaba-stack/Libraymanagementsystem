...
from .views import MemberListCreateView,MemberDetailView,CategoryListCreateView,CategoryDetailView,BookListCreateView,BookDetailView,AuthorListCreateView,AuthorDetailView,ReservationDetailView,ReservationListCreateView,BarrowListCreateView,BarrowDetailView
